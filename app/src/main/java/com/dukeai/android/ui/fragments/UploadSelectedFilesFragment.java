...
import com.dukeai.android.adapters.UploadImageFilesAdapter;
...
public class UploadSelectedFilesFragment extends Fragment implements PopupActions, HeaderActions {

    View view;
    @BindView(R.id.header)
    CustomHeader customHeader;
    @BindView(R.id.uploaded_files)
...
//        }
    ...
    void onClickUpload() {
        ...
        mFirebaseAnalytics.logEvent("UploadDocument", params);
    ...
    void uploadFiles(String streetAddress) {
        ...
        AsyncTask.execute(new Runnable() {
            ...
            public void run() {
                ...
                uploadFileViewModel.uploadFile(list, fileCount, address).observe(getActivity(), new Observer<FileUploadSuccessModel>() {
                    @Override
