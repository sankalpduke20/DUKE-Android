...
import com.dukeai.android.adapters.UploadImageSelectionAdapter;
import com.dukeai.android.interfaces.HeaderActions;
import com.dukeai.android.interfaces.PopupActions;
import com.dukeai.android.interfaces.SelectPhotoListener;
...
public class SelectPhotoFragment extends Fragment implements SelectPhotoListener, PopupActions, HeaderActions {

    View selectPhotoView;
    @BindView(R.id.header)
    CustomHeader commonHeader;
    @BindView(R.id.select_pictures)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ButterKnife.bind(this, selectPhotoView);
        context = getContext();
        popupActions = this;
        setInitials();
...
//            onClickReselectGroup();
    ...
    @OnClick(R.id.group_upload_button)
