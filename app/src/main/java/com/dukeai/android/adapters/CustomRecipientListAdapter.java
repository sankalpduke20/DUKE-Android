...
public class CustomRecipientListAdapter extends RecyclerView.Adapter<CustomRecipientListAdapter.CustomRecipientListHolder> {
    ...
    public CustomRecipientListAdapter(ArrayList<RecipientDataModel> listdata, OnListItemClickListener onListItemClickListener, OnlastItemLoadedListener onlastItemLoadedListener) {
