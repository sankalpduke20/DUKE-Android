...
public class LoadsFilterSpinnerAdapter extends ArrayAdapter implements SpinnerAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view == null) {
            loadsFilterSpinnerHolder = new LoadsFilterSpinnerAdapter.LoadsFilterSpinnerHolder();
            ...
            loadsFilterSpinnerHolder = (LoadsFilterSpinnerAdapter.LoadsFilterSpinnerHolder) convertView.getTag();
        }
    ...
    public View getDropDownView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        LoadsFilterSpinnerAdapter.LoadsFilterSpinnerHolder loadsFilterSpinnerHolder = new LoadsFilterSpinnerAdapter.LoadsFilterSpinnerHolder();
